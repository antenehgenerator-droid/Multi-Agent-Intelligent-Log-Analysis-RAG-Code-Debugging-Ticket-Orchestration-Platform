...
@Component
public class FrontendPersonaAgent extends BasePersonaAgent {

  public FrontendPersonaAgent(
      PersonaLlmClient llmClient, ResourceLoader loader, ObjectMapper objectMapper) {
    super("Frontend Engineer", "frontend.txt", llmClient, loader, objectMapper);
  }
}
